...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Конструюваня програмного забезпечення\Lab2'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Конструюваня програмного забезпечення\Lab2\Scripts\deactivate.nu'
